...
public class ReceiptAdapterTest {
    ...
    public void setUp() throws Exception {
        mAdapter = new ReceiptAdapter(Robolectric.application, new Receipt[]{
    ...
    private void forceLosAngeles() {
        mAdapter.setTimezone(TimeZone.getTimeZone("America/Los_Angeles"));
    }

    @Test
    public void getItemId_shouldReturnIndex() throws Exception {
        assertEquals(666L, mAdapter.getItemId(666));
    }
    ...
    public void getView_canUseRecycledView() throws Exception {
        View viewToRecycle = mAdapter.getView(0, null, null);
        View view = mAdapter.getView(1, viewToRecycle, null);
    ...
    public void canSwitchTimezonesForTestingPurposes() throws Exception {
        mAdapter.setTimezone(TimeZone.getTimeZone("America/New_York"));
        View atlanticView = mAdapter.getView(0, null, null);
        assertEquals("1970-01-12 08:46:40", ((TextView)atlanticView.findViewById(R.id.date)).getText());
        forceLosAngeles();
        View pacificView = mAdapter.getView(0, null, null);
